...
public class Interpreter {
     ...
     * @param cursor
     * @param variables
     * @param numLine the line number of the current execute instruction
     */
    public static void interpret(String input, Interface interfaceInstance, MapCursor cursors, Cursor cursor, MapVariable variables, int numLine) {
        ...
        // Interrompt l'exécution de la méthode si la liste d'instructions est vide ou si l'interruption est appelée.
        ...
        for (String instruction : instructions) {
            ...
            // Si le nombre maximum d'instructions est dépassé, l'exécution est interrompue.
    ...
    private static boolean evaluateBooleanExpression(String condition) throws IllegalArgumentException{
        ...
        for (String logicalPart : logicalParts) {
            ...
            If so soring the information in a variable "negated" to invert the final boolean result of the part.
            */
